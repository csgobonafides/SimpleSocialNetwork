...
async def test_get_id_200(xclient: AsyncClient, jwt_token: str):
    ...
    response = await xclient.get("/social_page/users/get/1", headers=headers)
...
async def test_get_id_403(xclient: AsyncClient):
    response = await xclient.get("/social_page/users/get/1")
...
async def test_get_id_404(xclient: AsyncClient, jwt_token: str):
    ...
    response = await xclient.get("/social_page/users/get/22", headers=headers)
